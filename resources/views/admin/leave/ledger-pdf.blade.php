...
<div class="header">
    <div class="header-left">
        <div class="title">Leave Ledger Report</div>
...
<table class="ledger">
    ...
    <tbody>
        ...
        @empty
            <tr><td colspan="9" style="text-align:center; color:#9ca3af; padding: 16px;">No ledger entries recorded for this employee.</td></tr>
        @endforelse
    </tbody>
</table>

<div class="footer">
    NexHRIS — Generated by {{ auth()->user()->name }} on {{ $generatedAt->format('F d, Y g:i A') }}
</div>
