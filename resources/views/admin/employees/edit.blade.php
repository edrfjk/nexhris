...
@section('content')
<form method="POST" action="{{ route('admin.employees.update', $employee) }}" class="bg-white rounded shadow p-6 max-w-2xl space-y-4">
    @csrf @method('PUT')
    ...
    <div class="flex gap-2 pt-2">
        <button class="bg-maroon-800 text-white px-4 py-2 rounded text-sm hover:bg-maroon-900">Update Employee</button>
